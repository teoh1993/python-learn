...
stmt = np.array([True, 1, 2]) + np.array([3, 4, False])
print(stmt)
...
updated = baseball = [[74.0, 180.0, 22.99], [74.0, 215.0, 34.69], [72.0, 210.0, 30.78], [72.0, 210.0, 35.43],
